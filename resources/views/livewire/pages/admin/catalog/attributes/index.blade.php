    ...
    <div class="mx-auto max-w-[1480px]">
        ...
        <x-ui.modal id="attribute-editor" width="lg" :heading="$editingId ? 'Edit attribute' : 'Add attribute'" description="Use one value per line for select attributes.">
            <div class="space-y-4">
                ...
                <div class="grid gap-3 sm:grid-cols-3"><label class="flex items-center gap-2 text-sm font-semibold"><input type="checkbox" wire:model.live="is_filterable" class="rounded border-slate-300 text-blue-600"> Filterable</label><label class="flex items-center gap-2 text-sm font-semibold"><input type="checkbox" wire:model.live="is_required" class="rounded border-slate-300 text-blue-600"> Required</label><label class="flex items-center gap-2 text-sm font-semibold"><input type="checkbox" wire:model.live="is_active" class="rounded border-slate-300 text-blue-600"> Active</label></div>
