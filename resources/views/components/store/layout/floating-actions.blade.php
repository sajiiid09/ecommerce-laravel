@props(['whatsappNumber' => null])

<div class="fixed bottom-5 right-5 z-40 size-12">
    @if (filled($whatsappNumber))
        <a href="{{ 'https://wa.me/'.rawurlencode((string) $whatsappNumber).'?text='.rawurlencode('Hello StoreZ') }}" target="_blank" rel="noopener noreferrer"
            ...
            <svg width="48" height="48" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" class="size-12" aria-hidden="true" focusable="false">
