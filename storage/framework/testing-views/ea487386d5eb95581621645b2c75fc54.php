...
<section class="rounded-card border border-store-border bg-white p-6 shadow-store-soft sm:p-8"><div class="text-center"><img src="<?php echo e(asset('images/brand/storez-logo.png')); ?>" alt="StoreZ" class="mx-auto w-32"><h1 class="mt-6 text-2xl font-extrabold text-store-ink">Welcome back</h1><p class="mt-1 text-sm text-store-muted">Sign in to continue shopping.</p></div><form action="<?php echo e(route('store.home')); ?>" class="mt-8 space-y-4"><label class="block text-sm font-semibold text-store-ink">Email address<input type="email" required class="mt-2 h-11 w-full rounded-control border border-store-border px-3 outline-none focus:border-store-blue focus:ring-2 focus:ring-store-blue/10"></label><label class="block text-sm font-semibold text-store-ink">Password<input type="password" required class="mt-2 h-11 w-full rounded-control border border-store-border px-3 outline-none focus:border-store-blue focus:ring-2 focus:ring-store-blue/10"></label><div class="flex items-center justify-between text-sm"><label class="flex items-center gap-2 text-store-muted"><input type="checkbox" class="size-4 rounded border-store-border text-store-blue">Remember me</label><a href="#forgot" class="font-semibold text-store-blue">Forgot password?</a></div><button class="h-11 w-full rounded-control bg-store-blue text-sm font-bold text-white hover:bg-store-blue-dark">Sign In</button></form><p class="mt-6 text-center text-sm text-store-muted">New to StoreZ? <a href="<?php echo e(route('register')); ?>" wire:navigate class="font-bold text-store-blue">Create an account</a></p></section> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?></main>
<?php /**PATH C:\xampp\htdocs\storez\resources\views/pages/auth/login-content.blade.php ENDPATH**/ ?>