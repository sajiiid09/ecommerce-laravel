...
?>
<main x-data="{ quantity: 1, wished: false, selectedOption: <?php echo \Illuminate\Support\Js::from($options[0]['value'] ?? null)->toHtml() ?>, selectedImage: <?php echo \Illuminate\Support\Js::from($gallery[0])->toHtml() ?> }" class="bg-white py-6 sm:py-8">
        ...
        <div class="grid gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
            <section class="grid gap-3 sm:grid-cols-[88px_minmax(0,1fr)]">
                <div class="order-2 flex gap-2 overflow-x-auto sm:order-1 sm:flex-col">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <button type="button" class="size-20 shrink-0 rounded-control border bg-white p-2"
                            :class="selectedImage === <?php echo \Illuminate\Support\Js::from($image)->toHtml() ?> ? 'border-2 border-store-blue' : 'border-store-border'"
                            @click="selectedImage = <?php echo \Illuminate\Support\Js::from($image)->toHtml() ?>"
                            :aria-label="'Show image ' + <?php echo e($loop->iteration); ?> + ' of <?php echo e(count($gallery)); ?>'"><img
                                src="<?php echo e(asset(ltrim($image, '/'))); ?>" alt="<?php echo e($product['name']); ?>"
                ...
                <div
                    ...
                    <img :src="selectedImage" src="<?php echo e(asset(ltrim($gallery[0], '/'))); ?>" alt="<?php echo e($product['name']); ?>"
                        class="size-full object-contain"></div>
            </section>
            <section>
                <div class="flex items-start justify-between gap-4">
                    <div>
                        <p class="text-sm font-semibold text-store-blue"><?php echo e($product['brand']); ?></p>
                        ...
                        @click="wished = !wished"
                        :aria-label="wished ? 'Remove from wishlist' : 'Add to wishlist'"><?php if (isset($component)) { $__componentOriginal56804098dcf376a0e2227cb77b6cd00a = $component; } ?>
...
<?php endif; ?></button>
                ...
                <div class="mt-3 flex flex-wrap items-center gap-3"><?php if (isset($component)) { $__componentOriginal2204ff34acdbc9251ea7783560d4d3e2 = $component; } ?>
...
<?php endif; ?><span class="text-store-border">|</span><span
                        class="text-sm text-store-muted">10K+ Sold</span></div>
                <div class="mt-5 flex flex-wrap items-center gap-3"><?php if (isset($component)) { $__componentOriginala9c2fcf5cbbd09be7a2e058ff30341d8 = $component; } ?>
...
<?php endif; ?></div>
                <p class="mt-2 flex items-center gap-1 text-sm font-semibold text-store-success"><?php if (isset($component)) { $__componentOriginal56804098dcf376a0e2227cb77b6cd00a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal56804098dcf376a0e2227cb77b6cd00a = $attributes; } ?>
...
<?php unset($__componentOriginal56804098dcf376a0e2227cb77b6cd00a); ?>
<?php endif; ?> Save
                    ৳<?php echo e(number_format(($product['oldPrice'] ?? $product['price']) - $product['price'])); ?> on this
                    product</p>
                ...
                <ul class="mt-4 list-disc space-y-1 pl-5 text-sm leading-6 text-store-text">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $highlights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $highlight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <li><?php echo e($highlight); ?></li>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </ul>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product['slug'] === 'premium-basmati-rice'): ?>
                <div class="mt-5">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product['slug'] !== 'premium-basmati-rice' && count($options)): ?>
                    <div class="mt-5">
                        ...
                        <div class="mt-2 flex flex-wrap gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <button type="button" class="rounded-full border px-4 py-2 text-sm" :class="selectedOption === <?php echo \Illuminate\Support\Js::from($option['value'])->toHtml() ?> ? 'border-store-blue bg-store-blue-soft font-bold text-store-blue' : 'border-store-border'" @click="selectedOption = <?php echo \Illuminate\Support\Js::from($option['value'])->toHtml() ?>"><?php echo e($option['label']); ?> ৳<?php echo e(number_format($option['price'])); ?></button>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div class="mt-5 flex flex-wrap items-center gap-3"><span
                        class="text-sm font-semibold text-store-ink">Quantity:</span><?php if (isset($component)) { $__componentOriginal3f9e90c5f70701b356639049e6e7a67c = $component; } ?>
...
<?php endif; ?></div>
                <div class="mt-5 grid gap-3 sm:grid-cols-2"><button type="button"
                        ...
                        @click="addToCart(<?php echo \Illuminate\Support\Js::from($product)->toHtml() ?>, quantity)"><?php if (isset($component)) { $__componentOriginal56804098dcf376a0e2227cb77b6cd00a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal56804098dcf376a0e2227cb77b6cd00a = $attributes; } ?>
...
<?php $component = $__componentOriginal56804098dcf376a0e2227cb77b6cd00a; ?>
<?php unset($__componentOriginal56804098dcf376a0e2227cb77b6cd00a); ?>
<?php endif; ?>Add to Cart</button><button type="button"
                        class="inline-flex h-12 items-center justify-center gap-2 rounded-control bg-store-red text-sm font-bold text-white"><?php if (isset($component)) { $__componentOriginal56804098dcf376a0e2227cb77b6cd00a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal56804098dcf376a0e2227cb77b6cd00a = $attributes; } ?>
...
<?php $component = $__componentOriginal56804098dcf376a0e2227cb77b6cd00a; ?>
<?php unset($__componentOriginal56804098dcf376a0e2227cb77b6cd00a); ?>
<?php endif; ?>Buy Now</button></div><button
                    type="button"
                    class="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-store-muted hover:text-store-red"
                    @click="wished = !wished"><?php if (isset($component)) { $__componentOriginal56804098dcf376a0e2227cb77b6cd00a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal56804098dcf376a0e2227cb77b6cd00a = $attributes; } ?>
...
<?php endif; ?><span
        ...
        <section class="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <div class="flex items-center gap-3 rounded-card border border-store-border p-4"><?php if (isset($component)) { $__componentOriginal56804098dcf376a0e2227cb77b6cd00a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal56804098dcf376a0e2227cb77b6cd00a = $attributes; } ?>
...
<?php endif; ?>
        ...
        <section class="mt-8 rounded-card border border-store-border bg-white">
            <div class="flex gap-6 overflow-x-auto border-b border-store-border px-5"><button type="button"
                    ...
                    (<?php echo e(number_format($product['reviews'])); ?>)</button><button type="button"
            ...
            <div class="grid gap-6 p-5 text-sm leading-7 text-store-text lg:grid-cols-[1.3fr_1fr]">
                <div>
                    <p><?php echo e($product['name']); ?> is carefully selected from trusted suppliers to bring you dependable
                ...
                <dl class="divide-y divide-store-border rounded-control border border-store-border">
                    <div class="flex justify-between gap-4 px-3 py-2">
                        ...
                        <dd><?php echo e($product['brand']); ?></dd>
                    </div>
                    <div class="flex justify-between gap-4 px-3 py-2">
                    ...
                    <div class="flex justify-between gap-4 px-3 py-2">
                        ...
                        <dd>STOREZ-<?php echo e($product['id']); ?></dd>
                    </div>
                </dl>
            </div>
        </section>
...
<?php /**PATH D:\projects\laravel\storez\resources\views/pages/store/product.blade.php ENDPATH**/ ?>