...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <div class="flex flex-wrap items-end justify-between gap-4">
            <div>
                ...
                @click="wishlist.forEach((id) => { const product = <?php echo \Illuminate\Support\Js::from($products)->toHtml() ?>.find((item) => item.id === id); if (product) addToCart(product); }); wishlist = []"
        ...
        <div class="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div x-show="wishlist.includes(<?php echo e($product['id']); ?>)"><?php if (isset($component)) { $__componentOriginalc573f75add0e58aeac1c3f6ba4c16330 = $component; } ?>
...
<?php endif; ?></div>
        ...
        <div x-cloak x-show="wishlist.length === 0"
            class="mt-6 rounded-card border border-store-border bg-white p-12 text-center"><?php if (isset($component)) { $__componentOriginal56804098dcf376a0e2227cb77b6cd00a = $component; } ?>
...
<?php /**PATH D:\projects\laravel\storez\resources\views/pages/store/wishlist-content.blade.php ENDPATH**/ ?>