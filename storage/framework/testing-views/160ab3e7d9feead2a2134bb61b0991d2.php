...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($asButton): ?>
    <button <?php echo e($attributes->class('cursor-pointer')); ?> type="button">
...
<?php endif; ?>
<?php $component->withAttributes(['attributes' => $attributes->class(['text-neutral-700 dark:text-neutral-300']),'data-slot' => 'icon']); ?>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><?php /**PATH C:\xampp\htdocs\storez\resources\views/components/ui/icon/index.blade.php ENDPATH**/ ?>