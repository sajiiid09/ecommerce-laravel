...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <section class="rounded-card border border-store-border bg-white p-6 shadow-store-soft sm:p-8">
            ...
            <form action="<?php echo e(route('account.dashboard')); ?>" class="mt-7 space-y-4">
            ...
            <p class="mt-6 text-center text-sm text-store-muted">Already have an account? <a href="<?php echo e(route('login')); ?>"
...
<?php endif; ?></main>
<?php /**PATH D:\projects\laravel\storez\resources\views/pages/auth/register-content.blade.php ENDPATH**/ ?>