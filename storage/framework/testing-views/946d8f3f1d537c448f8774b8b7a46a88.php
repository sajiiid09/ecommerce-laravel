...
<?php endif; ?>
            ...
            <section>
                <div
                    ...
                    <div class="flex items-center gap-2"><label for="sort-products"
                            class="text-xs font-semibold text-store-muted">Sort by</label><select id="sort-products"
                            name="sort" onchange="this.form.submit()"
                            class="h-10 rounded-control border border-store-border bg-white px-3 text-sm text-store-ink">
                            <option value="popular" <?php if($sort === 'popular'): echo 'selected'; endif; ?>>Popularity</option>
