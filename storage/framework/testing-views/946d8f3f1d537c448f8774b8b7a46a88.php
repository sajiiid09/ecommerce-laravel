...
<?php endif; ?>
        <div class="flex flex-wrap items-end justify-between gap-4">
            <div>
                <h1 class="text-2xl font-extrabold tracking-tight text-store-ink sm:text-3xl"><?php echo e($categoryName); ?></h1>
                <p class="mt-1 text-sm text-store-muted">Browse quality products at everyday StoreZ prices.</p>
                ...
                @click="filtersOpen = true" aria-controls="category-filters"
...
<?php endif; ?>Filters</button>
        ...
        <form method="GET" class="mt-6 grid gap-5 lg:grid-cols-[240px_minmax(0,1fr)]">
            ...
            <aside id="category-filters" x-cloak x-show="filtersOpen || window.innerWidth >= 1024" x-transition
                ...
                <div class="flex items-center justify-between">
                    <h2 class="font-bold text-store-ink">Filters</h2>
                    <div class="flex items-center gap-3"><a href="<?php echo e(route('store.category', ['slug' => $slug])); ?>"
...
<?php endif; ?></button></div>
                ...
                <div class="mt-5 space-y-5">
                    <fieldset>
                        <legend class="text-sm font-bold text-store-ink">Categories</legend>
                        <div class="mt-3 space-y-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <a wire:navigate href="<?php echo e(route('store.category', ['slug' => $category['slug']])); ?>"
                                    class="block text-sm <?php echo e(($slug ?? null) === $category['slug'] ? 'font-bold text-store-blue' : 'text-store-text hover:text-store-blue'); ?>"><?php echo e($category['name']); ?></a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
                    </fieldset><?php if (isset($component)) { $__componentOriginaleadf2e85c5e8c348d9a095e7163fe50c = $component; } ?>
...
<?php endif; ?>
                ...
                <button class="mt-5 h-10 w-full rounded-control bg-store-blue text-sm font-bold text-white"
            ...
            <section>
                <div
                    ...
                    <p class="text-sm text-store-muted">Showing <span
                            class="font-bold text-store-ink"><?php echo e(count($products)); ?></span> products</p>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'sort','x-model' => 'selectedSort','size' => 'sm','placeholder' => 'Popularity','trigger-class' => '!bg-white !text-store-ink dark:!bg-white dark:!text-store-ink','@change' => 'setTimeout(() => $el.closest(\'form\').submit())','class' => 'w-48']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.select.option','data' => ['value' => 'popular']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => 'popular']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
Popularity <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div><?php if (isset($component)) { $__componentOriginalaace2f446995b0a7ee6075fadb75f884 = $component; } ?>
...
<?php /**PATH D:\projects\laravel\storez\resources\views/pages/store/category-content.blade.php ENDPATH**/ ?>