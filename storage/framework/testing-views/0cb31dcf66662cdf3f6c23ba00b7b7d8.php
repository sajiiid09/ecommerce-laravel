...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['label' => 'Carousel', 'loop' => false, 'showDots' => true, 'showControls' => true]));
...
foreach (array_filter((['label' => 'Carousel', 'loop' => false, 'showDots' => true, 'showControls' => true]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div x-data="storeCarousel({ loop: <?php echo \Illuminate\Support\Js::from($loop)->toHtml() ?> })" x-init="init()" <?php echo e($attributes->class('relative')); ?> aria-roledescription="carousel" aria-label="<?php echo e($label); ?>">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showDots || $showControls): ?>
    <div class="mt-4 flex items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-1.5" role="tablist" aria-label="<?php echo e($label); ?> pages">
...
<?php /**PATH C:\xampp\htdocs\storez\resources\views/components/store/ui/carousel.blade.php ENDPATH**/ ?>