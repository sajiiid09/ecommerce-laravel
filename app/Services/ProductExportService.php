...
use App\Models\{Product, ProductExport};
...
class ProductExportService
{
    ...
    {
        $export = ProductExport::create(['type' => 'products', 'format' => 'csv', 'scope' => $ids ? 'selected' : 'all', 'fields' => $fields, 'include_variants' => $includeVariants, 'disk' => 'local', 'status' => 'processing', 'requested_by' => auth()->id()]);
