...
it('renders product reviews with the Sheaf data table and paginator', function () {
    ...
    Livewire::actingAs($admin)
        ...
        ->assertSee('Action')
        ->assertSeeInOrder(['Product', 'Customer', 'Rating', 'Status', 'Action'])
        ->assertDontSee('Review title 15')
        ->assertSee('wire:click="previousPage"', false)
        ->assertSee('wire:click="nextPage"', false)
        ->assertSee('wire:loading.attr="data-loading"', false)
